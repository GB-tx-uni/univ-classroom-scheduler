...
export default function Navbar() {
    ...
    return (
        <>
            <nav className="top-0 absolute z-50 w-full flex flex-wrap items-center justify-between px-2 py-2 navbar-expand-lg bg-blueGray-800">
                ...
                >
                  ...
                  <span className="lg:hidden inline-block ml-2">Star</span>
                            ...
                            <li className="flex items-center">
                                <div
                                    className={
                                        "text-white p-3 text-center inline-flex items-center justify-center w-14 h-14 shadow-lg rounded-full "
